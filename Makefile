...
SRC = main.c mcusleep.c wdt.c pwm.c buttons.c disp.c disp_draw.c lcd.c font.c i2c.c
...
#AVRDUDE_WRITE_FUSES = -U lfuse:w:0xe2:m -U hfuse:w:0xdf:m -U efuse:w:0x01:m # attiny85, 8MHz, DIV/1
...
AVRDUDE_FLAGS += $(AVRDUDE_WRITE_FUSES)
