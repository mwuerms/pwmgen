...
#define PIN_BUTTON_ON_OFF (0) // A0, PCINT8,  on/off button
#define PIN_BUTTON_WHEEL (1)  // A1, PCINT9,  button of rotary encoder
#define PIN_WHEEL_A (2)       // A2, PCINT10, rotary encoder signal A
#define PIN_WHEEL_B (3)       // A3, PCINT11, rotary encoder signal B
